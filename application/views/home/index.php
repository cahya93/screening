...
<head>
    ...
    <!-- style css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/assets/fronted/css/style.css">
    <!-- Responsive-->
    <link rel="stylesheet" href="<?= base_url(); ?>/assets/fronted/css/responsive.css">
    <!-- fevicon -->
    <link rel="icon" href="<?= base_url(); ?>/assets/fronted/images/fevicon.png" type="image/gif" />
    <!-- Scrollbar Custom CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>/assets/fronted/css/jquery.mCustomScrollbar.min.css">
    <!-- Tweaks for older IEs-->
    <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
    <!-- owl stylesheets -->
    <link rel="stylesheet" href="<?= base_url(); ?>/assets/fronted/css/owl.carousel.min.css">
...
<body>
    ...
    <div class="header_section">
        <div class="container-fluid">
            <div class="main">
                <div class="logo"><a href="index.html"><img src="<?= base_url(); ?>/assets/fronted/images/logo.png"></a></div>
                <div class="menu_text">
                    <ul>
                        <div class="togle_">
                            <div class="menu_main">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="banner_img"><img src="<?= base_url(); ?>/assets/fronted/images/banner-img.png"></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="taital_main">
                        <div class="taital_left">
                            <div class="play_icon"><img src="<?= base_url(); ?>/assets/fronted/images/play-icon.png"></div>
                        </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="news_section_2 layout_padding">
                            <div class="box_main">
                                <div class="image_1"><img src="<?= base_url(); ?>/assets/fronted/images/news-img.png"></div>
